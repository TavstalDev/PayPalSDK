...
public class WebhooksVerifyTests : TestBase
{
    ...
    public async Task WebhooksVerify_Sample1()
    {
        ...
        var body = JsonConvert.DeserializeObject<WebhookVerifyRequestBody>(resource.JsonRequest!);
        ...
        var objectResponse = await response.Content.ReadFromJsonAsync<WebhookVerifyResponseBody>();
