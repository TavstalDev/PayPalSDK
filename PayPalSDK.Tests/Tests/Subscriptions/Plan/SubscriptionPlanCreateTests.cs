...
public class SubscriptionPlanCreateTests : TestBase
{
    ...
    public async Task SubscriptionPlanCreate_Sample1()
    {
        ...
        var body = JsonConvert.DeserializeObject<SubscriptionPlanCreateRequestBody>(resource.JsonRequest!);
        ...
        var objectResponse = await response.Content.ReadFromJsonAsync<SubscriptionBody>();
