...
/// </summary>
public class OrderReceiveUpdateCallback : HttpRequestBase<OrderBody>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="OrderReceiveUpdateCallback"/> class.
    /// </summary>
    ...
    public OrderReceiveUpdateCallback(OrderUpdateCallbackRequestBody requestBody) 
    ...
    /// <returns>The current instance of <see cref="OrderReceiveUpdateCallback"/> for method chaining.</returns>
    public OrderReceiveUpdateCallback PaypalPartnerAttributionId(string paypalPartnerAttributionId)
    {
