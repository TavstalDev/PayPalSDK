...
public class SubscriptionListRequest : HttpRequestBase<SubscriptionBody>
{
    ...
    /// <param name="createdAfet">Optional ISO 8601 date-time string specifying the earliest subscription creation date to include in the results.</param>
    ...
    /// <param name="updatedAfet">Optional ISO 8601 date-time string specifying the earliest subscription status update date to include in the results.</param>
    ...
    public SubscriptionListRequest(string? planIds = null, string? statuses = null, string? createdAfet = null, string? createdBefore = null, 
        ...
        : base(HttpMethod.Get, $"/v1/billing/subscriptions")
    {
        ...
        if (createdAfet != null) queryParams.Add($"created_after={createdAfet}");
        if (createdBefore != null) queryParams.Add($"created_before={createdBefore}");
        if (updatedAfet != null) queryParams.Add($"status_updated_after={updatedAfet}");
