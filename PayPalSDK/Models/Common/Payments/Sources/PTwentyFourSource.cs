...
public class PTwentyFourSource
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PTwentyFourSource"/> class.
    /// </summary>
    /// <param name="name">The name associated with the PTwentyFour payment source.</param>
    /// <param name="email">The email address associated with the PTwentyFour payment source.</param>
    /// <param name="countryCode">The country code associated with the PTwentyFour payment source.</param>
    /// <param name="experienceContext">The experience context for the payment source.</param>
    public PTwentyFourSource(string name, string email, string countryCode, ExperienceContext experienceContext)
    {
        Name = name;
        Email = email;
