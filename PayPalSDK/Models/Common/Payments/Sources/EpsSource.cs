...
public class EpsSource
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="EpsSource"/> class.
    /// </summary>
    /// <param name="name">The name associated with the EPS payment source.</param>
    /// <param name="countryCode">The country code associated with the EPS payment source.</param>
    /// <param name="experienceContext">The experience context for the payment source.</param>
    public EpsSource(string name, string countryCode, ExperienceContext experienceContext)
    {
        Name = name;
