...
public class SofortSource
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SofortSource"/> class.
    /// </summary>
    /// <param name="name">The name associated with the Sofort payment source.</param>
    /// <param name="countryCode">The country code associated with the Sofort payment source.</param>
    /// <param name="experienceContext">The experience context for the payment source.</param>
    public SofortSource(string name, string countryCode, ExperienceContext experienceContext)
    {
        Name = name;
